...
import 'kleur/colors';
import { $ as $$BaseBlog } from '../chunks/BaseBlog_ttmsPBoe.mjs';
...
const $$Imprint = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "BaseBlog", $$BaseBlog, { "meta": meta }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<h1 class="mb-6 mt-5 text-2xl font-bold">Imprint</h1> <p class="pt-5">
...
}, "C:/Users/jusoa/Documents/github/dev.quiachonj.us/src/pages/imprint.astro", void 0);

const $$file = "C:/Users/jusoa/Documents/github/dev.quiachonj.us/src/pages/imprint.astro";
const $$url = "/imprint";
