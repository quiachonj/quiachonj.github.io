...
var data = { name:"Josh Quiachon",
  titleOne:"Full-Stack Developer (.NET)",
  titleTwo:"Azure Cloud Developer",
  titleThr:"Solutions Architect",
  email:"josh@quiachonj.us",
  phone:"+1 (646)600-8732",
  linkedin:"https://linkedin.com/in/quiachonj",
  github:"https://github.com/quiachonj",
  location:"New York, NY",
  summary:"Hello! I am a Software Engineer with over 15 years of experience designing, modernizing, and scaling enterprise applications across cloud, desktop, and web platforms. Expert in the .NET ecosystem and Microsoft Azure, with a track record of leading modernization efforts, driving performance improvements, and delivering resilient architectures. Adept at mentoring teams, influencing technical direction, and partnering with stakeholders to deliver solutions that balance reliability, scalability, and cost efficiency.\n",
  experience:[ { title:"Independent Azure Consultant",
      company:"Amberlogica",
      location:"Remote, US",
      startDate:"Oct 2024",
      endDate:"Present",
      description:[ "Designed and delivered billing/accounting system on Azure App Services + ASP.NET Core + EF Core, exposing secure REST APIs.",
        "Built workflows with Azure SQL, Cosmos DB, Blob Storage, Service Bus, Queue Storage, Functions, and Redis to support scalable, message-driven billing and document automation operations.",
        "Automated deployments and managed CI/CD pipelines with Azure DevOps.",
        "Developed Power BI dashboards for real-time reporting.",
        "Partnered with stakeholders to streamline workflows, accelerating delivery cycles." ] },
    { title:"Senior .Net Full Stack Developer",
      company:"United Welfare Fund",
      location:"New Rochel, NY",
      startDate:"Feb 2009",
      endDate:"Nov 2023",
      description:[ "Modernized mission-critical operations by migrating legacy systems to ASP.NET Core + Blazor WebAssembly on Azure, improving UX and maintainability.",
    ...
    { title:"Software Development Engineer in Test",
      ...
      startDate:"Jan 2008",
      endDate:"Feb 2009",
      description:[ "Developed a UI test automation framework in C# with Microsoft UI Automation, increasing coverage and reducing regression testing cycles.",
  ...
  highlights:[ { title:"Billing Service Orchestrations",
      description:[ "Reduced downtime by 62% and improved throughput with event-driven services and Azure Service Bus.",
        "item2." ] },
    { title:"Document Automation Service",
      description:[ "Delivered audit-ready workflows and on-time document automation and reporting via Cosmos DB + Redis + Azure Functions.",
        "item 2" ] },
    { title:"Legacy Modernization",
      description:[ "Migrated AS400 → Blazor + Azure; eliminated technical debt and greatly improved overall UI and UX.",
        "item 2" ] },
    { title:"Cloud-Native ETL/ELT",
      description:[ "Reduced data latency from 12 min → 15 sec with Data Factory CDC pipelines + Redis caching.",
        "item 2" ] } ],
  ...
  skills:{ Languages:[ "C#",
    ...
    "Reporting and BI":[ "SSRS",
      "SSIS",
      "Power BI" ],
    "Cloud & DevOps":[ "Azure App Services",
      "Functions",
      "Storage",
      "Service Bus",
      "ADF" ],
